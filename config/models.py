...
MODELS: dict[str, ModelConfig] = {
    ...
    "lfm2": ModelConfig(
        ...
        description="Hybrid small model for edge tasks with strong instruction following",
        rank=4,
        default=False,
    ...
    "lfm2.5": ModelConfig(
        ...
        inference_dir="lfm2.5-inference",
        description="Edge-optimized 1.2B with 32K context, 239 tok/s decode on CPU, rivals larger models",
        rank=3,
        default=True,
