...
GESTURE_MODE_CONTEXT_LOCAL = """User is hands-free (limited input). TOTAL OUTPUT under 50 words (including any thinking). Minimize or skip thinking - just answer. End with: "Want [A] or [B]?" or "Say 'yes' for [next step]." Use single words/emojis for options."""
