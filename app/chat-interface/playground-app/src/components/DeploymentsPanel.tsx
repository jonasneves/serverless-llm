            ...
            <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1 text-xs text-slate-400 hover:text-blue-400 transition-colors truncate"
                        title="Open chat (⌘/Ctrl+O)"
                    >
                        {getHostLabel(normalizeBaseUrl(chatApiBaseUrl) || 'http://localhost:8080')}
