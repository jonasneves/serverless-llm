...
def download_model():
    ...
    repo_id = os.getenv("MODEL_REPO", "microsoft/Phi-3-mini-4k-instruct-gguf")
    filename = os.getenv("MODEL_FILE", "Phi-3-mini-4k-instruct-q4.gguf")
...
async def health_details():
    return {
        ...
        "model": MODEL_NAME,
        "format": "GGUF",
        "repo": os.getenv("MODEL_REPO", "microsoft/Phi-3-mini-4k-instruct-gguf"),
        "file": os.getenv("MODEL_FILE", "Phi-3-mini-4k-instruct-q4.gguf"),
        "n_ctx": int(os.getenv("N_CTX", "2048")),
        "n_threads": int(os.getenv("N_THREADS", "2")),
