      ...
      <div className="flex items-center gap-2 w-auto justify-end pointer-events-auto z-20">
        ...
        {onOpenExtract && (
          <button
            ...
            className="min-w-[42px] min-h-[42px] w-[42px] h-[42px] rounded-full bg-slate-800/50 flex items-center justify-center border border-slate-700/50 hover:border-emerald-500/50 transition-colors active:scale-95 focus:outline-none focus-visible:outline-none"
            title="Extract — live camera → JSON"
          >
