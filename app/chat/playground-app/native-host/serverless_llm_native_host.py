...
def _find_repo_root() -> Path:
    ...
    for parent in [here.parent, *here.parents]:
        if (parent / "Makefile").exists() and (parent / "app" / "chat" / "chat_server.py").exists():
            return parent
    raise RuntimeError("Could not locate repo root (expected Makefile and app/chat/chat_server.py)")
