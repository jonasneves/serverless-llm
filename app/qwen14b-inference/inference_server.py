"""
Qwen2.5 14B Inference Server (GGUF)
...
app = FastAPI(
    ...
    description="REST API for Qwen2.5 14B model inference using GGUF",
    version="1.0.0"
)
...
def download_model():
    ...
    repo_id = os.getenv("MODEL_REPO", "bartowski/Qwen2.5-14B-Instruct-GGUF")
    filename = os.getenv("MODEL_FILE", "Qwen2.5-14B-Instruct-Q4_K_M.gguf")
