"""
Llama 3.2 Inference Server (GGUF)
...
def download_model():
    ...
    repo_id = os.getenv("MODEL_REPO", "bartowski/Llama-3.2-3B-Instruct-GGUF")
    filename = os.getenv("MODEL_FILE", "Llama-3.2-3B-Instruct-Q4_K_M.gguf")
