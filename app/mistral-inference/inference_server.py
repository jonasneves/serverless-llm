...
def download_model():
    ...
    repo_id = os.getenv("MODEL_REPO", "bartowski/Mistral-7B-Instruct-v0.3-GGUF")
    filename = os.getenv("MODEL_FILE", "Mistral-7B-Instruct-v0.3-Q4_K_M.gguf")
...
async def health_details():
    return {
        ...
        "model": MODEL_NAME,
        "format": "GGUF",
        "repo": os.getenv("MODEL_REPO", "bartowski/Mistral-7B-Instruct-v0.3-GGUF"),
        "file": os.getenv("MODEL_FILE", "Mistral-7B-Instruct-v0.3-Q4_K_M.gguf"),
        "n_ctx": int(os.getenv("N_CTX", "2048")),
        "n_threads": int(os.getenv("N_THREADS", "2")),
