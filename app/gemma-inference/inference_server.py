"""
Gemma 2 9B Inference Server (GGUF)
...
def download_model():
    ...
    repo_id = os.getenv("MODEL_REPO", "bartowski/gemma-2-9b-it-GGUF")
    filename = os.getenv("MODEL_FILE", "gemma-2-9b-it-Q4_K_M.gguf")
...
async def health_details():
    return {
        ...
        "model": MODEL_NAME,
        "format": "GGUF",
        "repo": os.getenv("MODEL_REPO", "bartowski/gemma-2-9b-it-GGUF"),
        "file": os.getenv("MODEL_FILE", "gemma-2-9b-it-Q4_K_M.gguf"),
        "n_ctx": int(os.getenv("N_CTX", "2048")),
        "n_threads": int(os.getenv("N_THREADS", "2")),
