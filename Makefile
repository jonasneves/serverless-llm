...
.PHONY: help build lint lint-web knip format clean update-models sync-workflow-choices sync-readme tunnels-secret install-hooks inference deploy build-images down _purge-inference-history
